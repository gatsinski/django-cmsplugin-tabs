...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_tabs_cmstabslist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('template', self.gf('django.db.models.fields.CharField')(default='cmsplugin_tabs/tabs.html', max_length=255)),
        ))
        db.send_create_signal(u'cmsplugin_tabs', ['CMSTabsList'])
        ...
        db.create_table(u'cmsplugin_tabs_cmssingletab', (
            ...
            ('content', self.gf('djangocms_text_ckeditor.fields.HTMLField')(default='', blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cmsplugin_tabs_cmstabslist')
    ...
    models = {
        ...
        u'cmsplugin_tabs.cmssingletab': {
            ...
            'content': ('djangocms_text_ckeditor.fields.HTMLField', [], {'default': "''", 'blank': 'True'}),
